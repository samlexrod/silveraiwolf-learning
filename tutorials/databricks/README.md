...
|---|---|---|
| [`end-to-end/`](./end-to-end) | `silver-databricks-end-to-end` | The **broad, all-features tour** — 14 stages from Lakebase OLTP → medallion → governed semantic layer → AI/BI + Genie → Vector Search + pgvector retrieval. **Start here.** |
