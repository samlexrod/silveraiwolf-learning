...
@sp.table(
    name="bronze_cdc_trading_desks",
    comment="Raw CDC events from PostgreSQL trading_desks table via Kafka",
)
def bronze_cdc_trading_desks():
    ...
    return (
        ...
        .option("subscribe", "postgres.public.trading_desks")
