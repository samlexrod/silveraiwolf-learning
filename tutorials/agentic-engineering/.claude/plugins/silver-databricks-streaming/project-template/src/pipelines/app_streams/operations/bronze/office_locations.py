...
@sp.table(
    name="bronze_cdc_office_locations",
    comment="Raw CDC events from PostgreSQL office_locations table via Kafka",
)
def bronze_cdc_office_locations():
    ...
    return (
        ...
        .option("subscribe", "postgres.public.office_locations")
