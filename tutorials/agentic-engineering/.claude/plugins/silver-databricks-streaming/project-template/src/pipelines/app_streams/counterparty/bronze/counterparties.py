...
@sp.table(
    name="bronze_cdc_counterparties",
    comment="Raw CDC events from PostgreSQL counterparties table via Kafka",
)
def bronze_cdc_counterparties():
    ...
    return (
        ...
        .option("subscribe", "postgres.public.counterparties")
